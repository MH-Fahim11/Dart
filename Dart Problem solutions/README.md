...
1.  Create a program that asks the user to enter their name and their age. Print out a message that tells how many years they have to be 100 years old.  <a href="Exercise 1.dart" target="blank">Slove</a>
